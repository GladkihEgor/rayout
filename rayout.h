...
#define TARGETS_W       (WINDOW_W * 80 / 100)
#define TARGETS_COLS    (TARGETS_W / (TARGET_W + TARGETS_PADDING) + 1)
#define TARGETS_H       (WINDOW_H / 2 * 80 / 100)
#define TARGETS_ROWS    (TARGETS_H / (TARGET_H + TARGETS_PADDING) + 1)
